          ...
          <Card style={styles.outerCard}>
            <Card style={styles.innerCard}>
              ...
              <div style={styles.buttonsContainer}>
                {['Affiliate marktingqe','Digital markting','Coding', 'AI', 'Medicne', 'Health & fitness', 'Legal & financial advice', 'Languages', 'Hobbies & skills', 'Cryptocurrecny', 'Home improvement & DIY', 'Creative services', 'Education & tutoring', 'Entertainment & Leisure', 'Dropshipping', 'Pet services'].map((skill) => (
                  <Button
                    key={skill}
